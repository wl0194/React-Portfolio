...
import typing_warrior from "../../assets/images/typing_warrior.png";
import note_taker from "../../assets/images/note_taker.png";
import sourceUnknown from "../../assets/images/sourceUnknown.png";
            ...
            <Container>
                <Row>
                    <Col>
                        <h2>Projects</h2>
                        <p>Lorem Ipsum</p>
                        <Tab.Container id="works-tab" defaultActiveKey="first">
                            <Nav variant="pills" className="nav-pills mb-5 justify-content-center align-items-center" id="pills-tab">
                                <Nav.Item>
                                    <Nav.Link eventKey="first">React</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link eventKey="second">Email Template</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link eventKey="third">Landing Page</Nav.Link>
                                </Nav.Item>
                            </Nav>
                            <Tab.Content>
